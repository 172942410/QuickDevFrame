...
/**
 * Created by lipengjun on 2017/7/6.
 */
...
//    Bitmap对象保存味图片文件
    public static File saveBitmapFile(Bitmap bitmap,String bitmapUrl){
//        File file=new File("/mnt/sdcard/pic/01.jpg");//将要保存图片的路径
        File file=new File(bitmapUrl);//将要保存图片的路径
        try {
            BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(file));

            if( bitmap.getByteCount()>1024*512){//大于512k就压缩质量70%

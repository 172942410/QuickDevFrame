package com.perry.view.tabview;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
     ...
     * divider
     */
    private int mDividerColor=Color.parseColor("#0099ff");
    ...
    private int mTextSelectColor=Color.parseColor("#888888");
    private int mTextUnselectColor=Color.parseColor("#0099ff");
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mDividerColor = ta.getColor(R.styleable.CommonTabLayout_tl_divider_color, Color.parseColor("#0099ff"));
        ...
        mTextSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_textSelectColor, Color.parseColor("#0099ff"));
        mTextUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_textUnselectColor, Color.parseColor("#555555"));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.layout_tab_left_as, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.layout_tab_right_as, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.layout_tab_bottom_as, null);
            } else {
                tabView = View.inflate(mContext, R.layout.layout_tab_top_as, null);
            }
